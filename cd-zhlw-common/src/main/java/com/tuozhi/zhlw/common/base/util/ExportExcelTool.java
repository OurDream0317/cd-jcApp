...
public class ExportExcelTool {
    ...
    public static void exportExcelX(String title, Map<String, String> headMap, JSONArray jsonArray, String datePattern, int colWidth, OutputStream out) {
        ...
        for (Object obj : jsonArray) {
            ...
            JSONObject jo = (JSONObject) JSONObject.toJSON(obj);
            //LR自修改
//	          JSONObject jo = (JSONObject) JSONObject.toBean((JSONObject) obj);
    ...
    public static void downloadExcelFile(String title, Map<String, String> headMap, JSONArray ja, HttpServletResponse response) {
        try {
            ...
            ExportExcelTool.exportExcelX(title, headMap, ja, null, 0, os);
    ...
    public static void main(String[] args) throws IOException {
        ...
        map.put("deptid", 36);
        map.put("password", "3366");
        ja.add(map);
        Map<String, String> headMap = new LinkedHashMap<String, String>();

        headMap.put("deptid", "部门ID");
        headMap.put("loginName", "登录名称");
        headMap.put("userName", "主键");
        String title = "测试";

        OutputStream outXlsx = new FileOutputStream("D://b.xlsx");
        System.out.println("正在导出xlsx....");
        Date d2 = new Date();
        ExportExcelTool.exportExcelX(title, headMap, ja, null, 0, outXlsx);
