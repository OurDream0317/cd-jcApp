...
import com.tuozhi.zhlw.common.utils.DateUtils;
...
public class Exc {
    ...
    private static void setCellValue(Cell cell, Object obj) {
        ...
        if (obj instanceof String) {
            ...
            Date date = (Date) obj;
            if (date != null) {
                cell.setCellValue(DateUtils.timeFormat(date));
            }
        } else if (obj instanceof Calendar) {
            Calendar calendar = (Calendar) obj;
            if (calendar != null) {
                cell.setCellValue(DateUtils.timeFormat(calendar.getTime()));
            }
        } else if (obj instanceof Timestamp) {
            Timestamp timestamp = (Timestamp) obj;
            if (timestamp != null) {
                cell.setCellValue(DateUtils.timeFormat(new Date(timestamp.getTime())));
            }
